...
export default function IconCreate() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      await alertSuccess("Berhasil", res.data?.message || "Icon ditambahkan.");
    ...
    <div className="min-h-screen bg-gradient-to-br from-white via-blue-50 to-blue-100 text-gray-900 py-10 px-4">
      <div className="max-w-4xl mx-auto">
        <div className="mb-8 text-center md:text-left">
          ...
          <h1 className="text-3xl font-bold text-gray-900">Tambah Icon</h1>
          <p className="text-gray-600 mt-2">
            Input nama dan file path icon untuk fasilitas.
          </p>
        </div>
        ...
        <div className="bg-white rounded-2xl shadow-2xl border border-slate-100 p-8">
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="space-y-2">
              ...
              />
              {form.file_path_icon && (
                <p className="text-xs text-gray-500">Dipilih: {form.file_path_icon}</p>
              )}
            </div>
