...
export default function GambarHotelEdit() {
  ...
  const fetchData = async () => {
    ...
    try {
      ...
      console.error(err);
      alertError("Gagal memuat gambar", "Periksa koneksi atau coba lagi.");
    } finally {
      setLoading(false);
    }
  };
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      console.log(res.data);
      await alertSuccess("Berhasil", res.data?.message || "Gambar diperbarui.");
  ...
  if (loading) {
    return (
      <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-white via-blue-50 to-blue-100">
        <p className="text-sm text-gray-600">Memuat data gambar...</p>
      </div>
    );
  }
    ...
    <div className="min-h-screen bg-gradient-to-br from-white via-blue-50 to-blue-100 text-gray-900 py-10 px-4">
      <div className="max-w-4xl mx-auto">
        <div className="mb-8 text-center md:text-left">
          ...
          <h1 className="text-3xl font-bold text-gray-900">Edit Gambar Hotel</h1>
          <p className="text-gray-600 mt-2">Perbarui foto hotel dan simpan perubahan.</p>
        </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="space-y-2">
              ...
              {form.file_path_gambar_hotel && (
                <p className="text-xs text-gray-500">Saat ini: {form.file_path_gambar_hotel}</p>
              )}
            </div>
