...
export default function Settings() {
  ...
  useEffect(() => {
    ...
    if (raw) {
      try {
        ...
        if (typeof s.notifUpdate === "boolean")
          setNotifUpdate(s.notifUpdate);
      } catch (e) {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        console.log("Berhasil memuat settings");
      } catch (err) {
  ...
  const handleSave = (e) => {
    ...
    // kalau mau, kamu bisa tambahkan logika dark mode di sini
    // misalnya: document.documentElement.classList.toggle("dark", theme === "dark");
          ...
          <div className="flex items-center gap-3 mb-6">
            ...
            <div>
              ...
              <p className="text-sm text-gray-500 mt-1">
                Atur preferensi tampilan, notifikasi, dan keamanan akun Hotello Anda.
              </p>
            </div>
          </div>
            ...
            <div className="bg-white rounded-2xl shadow-md p-6">
              ...
              <div className="space-y-4 text-sm">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-gray-500 text-xs mb-2">
                      ...
                      umum. Di versi berikutnya, Anda bisa melihat daftar perangkat
                      yang login dan mengeluarkan sesi tertentu.
                    </p>
                    <button
                      type="button"
                      onClick={() =>
                ...
                <p className="text-xs text-gray-400">
                  ...
                  <span className="font-semibold">Update Password</span> di halaman
                  Profil Saya.
                </p>
              </div>
            </div>
