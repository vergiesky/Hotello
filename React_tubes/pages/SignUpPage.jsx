...
export default function SignUpPage() {
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        // placeholder: kirim ke API
        alert(`Mendaftar: ${form.fullName} (${form.email})`);
    };
    ...
    return (
        <div className="min-h-screen bg-slate-50 flex items-start">
            ...
            <main className="w-full max-w-2xl mx-auto px-6 py-6">
                ...
                <form onSubmit={handleSubmit} className="bg-white rounded-xl p-8 shadow">
                    <label className="block mb-4">
                        ...
                        <input name="fullName" value={form.fullName} onChange={handleChange} placeholder="Full name" className="w-full border rounded-lg px-4 py-3 text-sm bg-slate-50" />
                    </label>
                    ...
                    <label className="block mb-4">
                        ...
                        <input name="phone" value={form.phone} onChange={handleChange} placeholder="Phone number" className="w-full border rounded-lg px-4 py-3 text-sm bg-slate-50" />
                    </label>

                    <label className="block mb-6">
                        <div className="text-sm font-medium mb-2">Password</div>
                        <input name="password" type="password" value={form.password} onChange={handleChange} placeholder="Password" className="w-full border rounded-lg px-4 py-3 text-sm bg-slate-50" />
                    </label>

                    <button className="w-full bg-sky-300 text-slate-900 py-3 rounded-lg font-semibold">Sign Up</button>
                    ...
                    <button type="button" className="w-full border rounded-lg py-3 flex items-center justify-center gap-3">
                        ...
                        <div className="text-center mt-4 text-sm text-slate-400">Already have an account? <a href="#" className="text-sky-500">Sign In</a></div>
                </form>
            </main>
        </div>
    );
